...
import 'cypress-file-upload';
  ...
  Cypress.Commands.add('selectJourneyAction', (buttonName) => {
    switch (buttonName) {
      case 'New journey':
        cy.get(byId('new-journey-button'))
          .click()
        break
      case 'Get started with this journey':
        cy.get(byId('journey-template-preview_button-get-started'))
          .click()
        break
      case 'Choose list':
        cy.get(byId('chosen-list_choose-list-button'))
          .click()
        break
      case 'Use this message':
        cy.get(byId('collection-modal_save-button'))
          .click()
        break
      case 'Use this list':
        cy.get(byId('collection-modal_save-button'))
        ...
        break
      case 'Choose message':
        cy.get(byId('choose-message_button'))
          .click()
        break
      case 'Deactivate journey':
      case 'Activate journey':
        cy.get(byId('journey-state-panel_button'))
          .click()
        break
      case 'Yes, activate':
        cy.get('button')
          .contains('Yes, activate')
          .click()
        break
      case 'Pencil':
        cy.get(byId('journey-editor_edit-icon-button'))
          .click()
        break
      case 'List this journey applies to':
        cy.get(byId('choose-list_chosen-title'))
          .click()
        break
  ...
  Cypress.Commands.add('selectJourney', (journeyName) => {
    switch (journeyName) {
      case 'Anniversary':
        cy.contains('Message contacts an the anniversary of a date, e.g. birthday')
      ...
      case 'Not clicked':
        ...
        break
      case 'Welcome':
        cy.contains('Nurture, onboard or educate new contacts with a series of messages')
          .parent(byClass('panel-body journey-template-information'))
          .children(byClass('btn-success btn-block journey-template-button btn'))
          .click()
        break
  ...
  Cypress.Commands.add('selectJourneyNode', (journeyNode) => {
    ...
    switch (journeyNode) {
      ...
      case 'Send':
        ...
        break
      case 'Send_2':
        cy.get(byStyle('left: 0px; width: 300px; height: 89px; top: 461px; opacity: 1;'))  
          .click()
        break
      case 'Send_3':
        cy.get(byStyle('left: 0px; width: 300px; height: 89px; top: 772px; opacity: 1;'))
          .click()
        break
      default:
  ...
  Cypress.Commands.add('removeJourneyNode', (journeyNode) => {
    ...
    switch (journeyNode) {
      case 'Send_3':
        cy.get(byStyle('left: 0px; width: 300px; height: 89px; top: 777px; opacity: 1;'))
          .children(byClass('journey-node journey-node-type-sendToGroup'))
          .children(byClass('btn-default close btn'))  
          .click()
        break
      case 'Wait_2':
        cy.get(byStyle('left: 0px; width: 300px; height: 72px; top: 629px; opacity: 1;'))
  ...
  Cypress.Commands.add('addJourneyNode', (journeyNode) => {
    ...
    switch (journeyNode) {
      case 'Wait':
        cy.get(byStyle('left: 136px; width: 28px; height: 16px; top: 270px; opacity: 1;'))
          .click()
        cy.get(byId('add-step_wait'))
          .click()
        break
      case 'Send_2':
        cy.get(byStyle('left: 136px; width: 28px; height: 16px; top: 418px; opacity: 1;'))
          .click()
        cy.get(byId('add-step_send'))
          .click()
        break
      default:
        cy.log('WARNING: Journey node ' + journeyNode + ' does NOT exist')
  ...
  Cypress.Commands.add('selectCampaignAction', (buttonName) => {
    switch (buttonName) {
      ...
      case 'Start Now':
        ...
        break
      case 'Start Campaign':
        cy.get(byClass('btn btn-success flow-action-btn flow-finish'))
          .click({
            force: true
          })
        break
  ...
  Cypress.Commands.add('selectAutomationAction', (buttonName) => {
    switch (buttonName) {
      case 'New automation':
        cy.get(byClass('heading-row-form heading-row-form-right form-inline text-right ng-pristine ng-valid'))
          .children('a')
          .contains(buttonName)
          .click()
        break
  ...
  Cypress.Commands.add('selectRssAction', (buttonName) => {
    switch (buttonName) {
      case 'New RSS Feed':
        cy.get('button')
          .contains('New RSS Feed')
          .click()
        break
      case 'Delete this RSS Feed':
        cy.get('button')
          .contains('Delete this RSS Feed')
          .click()
        break
      case 'New RSS Region':
        cy.get(byClass('btn btn-success new-rss-region ng-binding ng-scope'))
          .click()
        break
      case 'Choose RSS Feed':
        cy.get('button')
          .contains('Choose RSS Feed')
          .click()
        break
      default:
        cy.log('WARNING: Button ' + buttonName + ' does not exist')
  ...
  Cypress.Commands.add('selectDynamicContentAction', (buttonName) => {
    switch (buttonName) {
      case 'New Dynamic Content Block':
        cy.get('button')
          .contains('New Dynamic Content Block')
          .click()
        break
      case 'Delete this Dynamic Content Block':
        cy.get('button')
          .contains('Delete this Dynamic Content Block')
          .click()
        break
      case 'New Dynamic Content Region':
        cy.get(byClass('btn btn-success new-dynamic-content-region ng-binding ng-scope'))
          .click()
        break
      default:
        cy.log('WARNING: Button ' + buttonName + ' does not exist')
  ...
  Cypress.Commands.add('selectCommonAction', (buttonName) => {
    switch (buttonName) {
      ...
      case 'OK':
        ...
        break
      case 'Emails':
        cy.get(byClass('btn btn-blank btn-md btn-text-lg btn-plain dropdown-toggle opaque ng-binding'))
          .contains('Emails')
          .click()
        break
      case 'Next Step':
      ...
      case 'Finish RSS Region':
        cy.get(byClass('btn btn-success pull-right finish-rss-region ng-binding'))
          .click()
        break
      case 'Start Now':
        cy.get(byClass('btn btn-success flow-action-btn flow-finish'))
      ...
      case 'Launch your campaign':
        cy.get(byClass('btn btn-success modal-action'))
          .click()
        break
      case 'Go to campaigns':
        cy.get(byClass('btn btn-success modal-confirm ng-binding'))
          .click()
        break
      case 'Add another subject line':
        cy.get(byClass('btn btn-default subject-line-adder ng-binding ng-scope'))
          .click()
        break
      default:
        cy.log('WARNING: Button ' + buttonName + ' does not exist')
  ...
  Cypress.Commands.add('openPage', (pageName) => {
    switch (pageName) {
      case 'Lists':
        cy.get(byClass('nav-item list'))
          .click()
        break
      case 'Messages':
        cy.get(byClass('nav-item messages'))
          .click()
        break
      case 'Campaigns':
        cy.get(byClass('nav-item campaigns'))
          .click()
        break
      case 'Journeys':
        cy.get(byClass('nav-item automations'))
          .click()
        cy.contains('Rule automations')
          .click()
        cy.get(byClass('ng-binding ng-scope'))
          .contains('Journeys')
          .click()
        break
      case 'Automations':
        ...
        break
      case 'Reports':
        cy.get(byClass('nav-item reports'))
          .click()
        break
      case 'Dashboard':
        cy.get(byTitle('Pure360'))
          .click()
        break
      default:
  ...
  Cypress.Commands.add('selectEditor', (editor) => {
    ...
    switch (editor) {
      case 'HTML':
        cy.get(byClass('message-actions-select-html'))
          .click()
        break
      case 'Plain Text':
        cy.get(byClass('message-actions-select-plaintext'))
          .click()
        break
      case 'Drag & Drop':
        cy.get(byClass('message-actions-select-draganddrop'))
          .click()
        break
      case 'Auto Message Import':
        cy.get('a')
          .contains('Auto Message Import')
          .click()
        break
        /*   case 'SMS':
  ...
  Cypress.Commands.add('selectEditorAction', (action) => {
    switch (action) {
      case 'Dynamic content regions':
        cy.get(byClass('nav-item dynamic-content-regions'))
          .click()
        break
      case 'RSS Regions':
        cy.get(byClass('nav-item rss-regions'))
          .click()
        break
      case 'Toggle Editor':
        cy.get(byClass('nav-item toggle-visual-editor'))
          .click()
        break
      default:
  ...
  Cypress.Commands.add('selectRadio', (option) => {
    switch (option) {
      case 'Sign up & double opt-in':
        cy.get('div')
          .contains('Sign up & double opt-in')
          .click()
        break
      case 'Based on a date':
        cy.get('div')
          .contains('Based on a date')
          .click()
        break
      case 'Plain text editor':
        cy.get('label')
          .contains('Plain text editor')
          .click()
        break
      default:
  ...
  Cypress.Commands.add('selectCheckbox', (option) => {
    switch (option) {
      case 'Send a double opt in email':
        cy.get('div')
          .contains('Send a double opt in email')
          .click()
        break
      case 'Send a welcome email':
        cy.get('div')
          .contains('Send a welcome email')
          .click()
        break
      default:
        cy.log('WARNING: Option ' + option + ' is NOT available')
