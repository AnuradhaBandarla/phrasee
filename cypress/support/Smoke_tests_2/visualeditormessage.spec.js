...
describe('Visual editor message', function () {
  it('create a message using Visual editor', function () {
    ...
    cy.get('[class="cke_button_icon cke_button__sourcedialog_icon"]')
      .click({ force: true })
      .type(
        'why are the first few characters of the message is not getting entered'
      );
