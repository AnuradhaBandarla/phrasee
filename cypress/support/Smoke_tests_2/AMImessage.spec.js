...
describe('AMI message', function () {
  it('create an AMI message', function () {
    ...
    cy.get(
      '[p3-validator-message="strictUrl: Provide a valid url for your HTML import"]'
    ).type('https://www.thesun.co.uk/');
    cy.get(
      '[p3-validator-message="strictUrl: Provide a valid url for your Plain text import"]'
    ).type('https://www.thesun.co.uk/');
